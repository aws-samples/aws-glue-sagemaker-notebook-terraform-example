...
echo "https://glue.us-west-2.amazonaws.com" >> $glue_endpoint_file
...
aws glue get-dev-endpoint --endpoint-name ${glueendpoint} --endpoint https://glue.us-west-2.amazonaws.com
